...
class RssAutodlGui(tk.Tk):
    ...
    def build_ui(self) -> None:
        ...
        self.results_tree.column("source", width=90)
        self.results_tree.column("published", width=180)
        self.results_tree.column("savepath", width=280)
        self.results_tree.column("url", width=260)
        ...
        actions.grid(row=3, column=0, columnspan=5, sticky=tk.EW, pady=(8, 0))
